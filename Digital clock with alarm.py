...
root = Tk()
root.title("Digital Clock by @Lahiru-19/IT/506")
...
my_label2 = Label(root, font=("Digital-7 Mono", 21), bg="black", fg="cyan")
my_label2.pack()
clock()
...
def alarm(set_alarm_timer):
    while True:
        ...
        if now == set_alarm_timer:
            ...
            pygame.mixer.music.load("Alarm-ringtone.mp3")  # >pip install pygame
